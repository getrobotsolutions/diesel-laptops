...
function SelectFrame(num)
{
    ...
    else
    {
        ...
        frameImagePath = GetCurrentFolderPath() + "Images/Picture"+num+".png";
...
function SendEmail()
{
    ...
    var body = "Thank you for stopping by Diesel Laptops at TMC20.  Here is your photo from our robot. Have a great day! Diesel Laptops www.diesellaptops.com";
